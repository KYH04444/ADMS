...
//    var path_Car = mutableListOf<PathOverlay>()
...
//            println(path.coords[0])
            ...
            if (indx == 1)
            {
                ...
                car_idx += 1
                println("fuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuck")
                println("fuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuck")
                println(car_idx)
                println("fuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuck")
                println("fuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuck")
                ...
                cars[car_idx].movingtime = it[0].summary.duration / 60000
                car_idx += 1
                println("abcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabc")
                println("abcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabc")
                println(car_idx)
                println("abcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabc")
                println("abcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabc")
...
//                    cars[matching_car_idx].realmovingtime.add(3)
//                    println(cars[matching_car_idx].realmovingtime)
//                    println("234rtfrdewqefgrewerghbgre345yuhgfewq2w3e4rtyhgfdewqwerty")
                }
